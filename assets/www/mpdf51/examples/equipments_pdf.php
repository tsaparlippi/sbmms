...
<?php $equipments = mysql_query("SELECT * FROM equipments") or die(mysql_error());  ?>
...
$tbl .= '<tr>
		...
		<td style="background:#DCE4FF; border: 1px solid #fff;">'.$control_num.'</td>
