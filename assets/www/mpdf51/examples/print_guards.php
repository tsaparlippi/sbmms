...
<?php $assignment= $_POST['assignment']; ?>
<?php if ($assignment=='Assigned'){
...
?>
<?php $emp = mysql_query("SELECT * FROM employees WHERE  type='guard' AND assignment='$assignment'") or die(mysql_error());  ?>
